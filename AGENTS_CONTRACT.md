...
- Short-name-variable generated files: `cut.<name>.mp4`,
  ...
  `hyperframes/<name>.html` (the composition source, human/LLM-editable) and
  `hyperframes/<name>.raw.txt` (the LLM's raw response from
  `hyperframe --from-brief`) are **not** generated artifacts in this sense —
