...
(`reasonIds.ts` / `cutPatterns.ts` / `effectReasonIds.ts`)から
...
| [`effects/`](effects/README.md) | **EP2 実装済み** | 演出判断の7分類 + effectReasonId schema/注入。pattern注入・測定は EP3〜EP4 | [EP1](../plans/2026-07-21-effect-knowledge-p1-design.md) |
