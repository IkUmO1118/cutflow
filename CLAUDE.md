...
node src/cli.ts hyperframe-backends --json  # 収録dir不要・read-only。backendの4状態/tier/CDN pin/authoring経路/usable実render fixtureを純JSONで表示(Anime.js 3.2.2はmanual/byte/usable、既定は散文)
