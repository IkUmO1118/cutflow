...
// Source: src/components/video-editor/videoPlayback/cursorFollowUtils.ts (verbatim; imports rewritten to local .ts paths).
// Do not edit to "improve" — this is a faithful port. See ./PROVENANCE.md.
import type { CursorTelemetryPoint, ZoomFocus } from "./types.ts";
