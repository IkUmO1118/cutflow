...
// Source: src/components/video-editor/videoPlayback/focusUtils.ts (verbatim; imports rewritten to local .ts paths).
// Do not edit to "improve" — this is a faithful port. See ./PROVENANCE.md.
import { clampFocusToDepth, ZOOM_DEPTH_SCALES, type ZoomDepth, type ZoomFocus } from "./types.ts";
